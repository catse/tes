						...
						<?=  form_open_multipart('admin/products/create',['class'=>'form-group']) ?>
							<div class="form-group">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="pro_name" placeholder="Tambahkan Kategori" value="<?= set_value('pro_name') ?>">
								</div>
							</div>
							<div class="form-group">
								<div class="input-group">
									<div class="input-group-addon" style="min-width:150px;text-align:left;">Nama Produk</div>
									<input type="text" class="form-control" name="pro_title" placeholder="Tambahkan Nama Produk" value="<?= set_value('pro_title') ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="input-group-addon" style="min-width:150px;text-align:left;">Deskripsi</div>
									<textarea rows="4" class="form-control col-md-12" name="pro_description" placeholder="Tambahkan Keterangan"><?= set_value('pro_description') ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="pro_price" placeholder="" value="<?= set_value('pro_price') ?>">
