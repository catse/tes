			 ...
			 <div class="col-md-8">
                ...
                <div class="panel panel-default">
					<div class="panel-heading">
							<h3>Kategori :<?=$product->pro_name;?></h3>
              <h3>Nama     :<?=$product->pro_title;?></h3> 

                    </div>
					
                    <div class="panel-body" width="100px">
						<div class="col-md-12" style="height:250px;">
							<h4>Harga : IDR <?=$product->pro_price?></h4>
							<p>Keterangan : <?=$product->pro_description?></p>
              <p>Stok   :     <?=$product->pro_stock?></p>
						</div>  
						<div class="col-md-12">
