             ...
             <div class="col-md-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body" width="100px">
                            ...
                            <center><img width="75%" src="<?php echo base_url(); ?>assets/uploads/bukti.png"></center>
								<hr>
							...
							<?= form_open_multipart('customer/payment_confirmation/') ?>
								<div class="form-group">
									...
									<input type="text" class="form-control" name="invoice_id_input" placeholder="lihat nomor invoice pada history" value=<?=( $invoice_id != 0 ? $invoice_id:'')?> >
								</div>
                                <div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="keterangan" placeholder="Tambahkan keterangan seperti ukuran dan warna">
                                </div>
								<div class="form-group">
